...
#define LOGD(...) ((void)__android_log_print(ANDROID_LOG_DEBUG, "Substrate", __VA_ARGS__))
//
#define EntryD(...) ((void)__android_log_print(ANDROID_LOG_DEBUG, "Substrate Entry", __VA_ARGS__)
//
/*long GETLR(){
	long mLR = NULL;
